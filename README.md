...
* Original tutorial: https://github.com/anthropics/prompt-eng-interactive-tutorial
* Official Anthropic documentation: https://platform.claude.com/docs/en/get-started

### Note

This repository is a personal study copy of Anthropic’s *Prompt Engineering Interactive Tutorial*.

The original project was created and is maintained by Anthropic.

All original tutorial content, structure, and source materials belong to Anthropic. Any added notes, exercises, or modifications are my own learning work.
